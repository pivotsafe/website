...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "p-0.5  bg-transparent aspect-square  flex items-center justify-center w-full h-[300px] relative",
        className
      )}
    >
      <div
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative h-44 w-44  flex items-center justify-center text-white font-bold text-4xl">
            <div className="absolute mb-20">{icon}</div>
            <div className="absolute w-full h-full blur-sm " />

            <h3
              className="text-white  z-20 text-center text-[20px] font-bold mt-[40px]"
